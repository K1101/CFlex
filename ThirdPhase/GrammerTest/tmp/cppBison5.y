...
declaration_specifier_atlist : declaration_specifier {printf(" ----- in stage 1 ----");}
...
direct_declarator : identifier {printf (" ----- in stage 2 ----- ");}
...
declaration :  declaration_specifier_atlist init_declarator_crt ;
